...
class TestAPIEndpointsBasic:
    ...
    def test_api_endpoints_accessible(self, endpoint):
    ...
    @pytest.mark.skip(reason="Teams/Games endpoints have signature issues")
    def test_teams_games_endpoints(self):
        """Teams and games endpoints to be fixed."""
        pass

    @pytest.mark.skip(reason="Teams endpoint has signature issues")
    def test_teams_api_with_filter(self):
        """Test teams API with filter parameter."""
        pass

    def test_api_limit_parameter(self):
